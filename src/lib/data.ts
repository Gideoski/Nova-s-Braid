...
export const serviceCategories: ServiceCategory[] = [
  {
    ...
    name: 'Knotless',
    services: [
      { name: 'Small knotless shoulder', price: 13000 },
      { name: 'Medium knotless shoulder', price: 10000 },
      { name: 'Large knotless shoulder', price: 9000 },
      ...
      { name: 'Small knotless waist', price: 20000 },
      { name: 'Medium knotless waist', price: 17000 },
      { name: 'Large knotless waist', price: 14000 },
      { name: 'Small knotless bum length', price: 25000 },
      { name: 'Medium knotless bum length', price: 20000 },
